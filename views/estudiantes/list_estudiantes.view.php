            ...
            <?php foreach ($lista as $lista): ?>
              <tr class="border-b border-black dark:border-black filas-row" data-cedula=<?php echo $lista["cedula"] ?>>
                ...
                <td scope="col" class="px-6 py-3 flex justify-center">
                  ...
                  <a href="<?php echo PATH . $model . '/info?cedula=' . $lista['cedula'] ?>" class="p-2 bg-blue-100 hover:bg-blue-100 dark:text-blue-400 dark:hover:bg-blue-900/30 rounded-lg transition-colors group" title="Informacion del Docente">
                  ...
                  <a href="<?php echo PATH . $model . '/actualizar?cedula=' . $lista['cedula'] ?>" class="p-2 text-amber-600 hover:bg-amber-100 dark:text-amber-400 dark:hover:bg-amber-900/30 rounded-lg transition-colors group relative" title="Actualizar Datos">
