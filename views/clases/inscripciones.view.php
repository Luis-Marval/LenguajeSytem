...
<main class="flex-grow p-6 main-scroll">
  <div class="mb-2 flex">
    <h1 class="text-4xl text-primary w-50 i"> Inscripciones </h1>
  ...
  <div class="flex flex-col">
    <div class="card w-full">
      <div class="p-3 w-full overflow-x-auto">
              ...
              <?php foreach ($lista as $lista): ?>
                <tr class="out-b">
                  ...
                  <td scope="col" class="px-6 py-3">
                    <form method="get" action="<?php echo PATH . 'clases/periodo' ?>" class="inline-block">
                    ...
                    <?php
                    if (!empty($lista['idPeriodo']) && $lista['ultimoPeriodo'] == 1 && $lista['idProfesor'] != null && ($estudiate->countEstudiantes($lista['idPeriodo'])[0][0]) > 0): ?>
        ...
        <div class="w-full text-sm text-left text-gray-500 dark:text-gray-200 flex justify-end align-center line0 gap40 mt-2">
